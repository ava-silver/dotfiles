...
alias wget='wget -c'
alias ccat=/usr/bin/cat                              # In case regular cat usage is preferred
...
alias celeste-pull='cd ~/.local/share/Celeste && git pull ; cd -'
alias celeste-push='cd ~/.local/share/Celeste && g a && g c "Updated $(date)" && g pu ; cd -'
